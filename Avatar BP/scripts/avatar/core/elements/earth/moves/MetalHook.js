...
const traceLineFlat = (player, pStart, pEnd) => {
    try {
        ...
        customMap.setVector3("variable.plane", { x: 0.9, y: 0.9, z: 0.9 });
...
const move = {
    name: { translate: 'elements.earth.moves.metalhook.name' },
    description: { translate: 'elements.earth.moves.metalhook.description' },
